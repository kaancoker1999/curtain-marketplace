...
export const DEMO_PRODUCTS: ProductSummary[] = [
  { id: 'prod-cellular', orgId: 'org-carra-woods', orgName: 'Carra Woods', name: 'Hücreli Perde (Cellular Shade)', slug: 'cellular-shade', category: 'CELLULAR_SHADE', basePrice: 3600, currency: 'TRY', leadTimeDays: 10, description: 'Petek yapılı, ısı ve ses yalıtımlı; ölçüye özel üretim. Tül geçirgen, ışık süzen ve karartma seçenekleri.' },
